...
impl crate::traits::IntegerSequence for A000107 {
    const NAME: &str = "Number of labeled rooted trees";

    const HEAD: &[crate::Value] = &[
        0, 1, 2, 9, 64, 625, 7776, 117649, 2097152, 43046721, 1000000000, 25937424601,
        743008370688, 23298085122481, 793714773254144, 29192926025390625, 1152921504606846976,
    ];
