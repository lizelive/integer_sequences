...
impl crate::traits::IntegerSequence for A000106 {
    ...
    const HEAD: &[crate::Value] = &[
        ...
        23409, 29241, 36100, 44100, 53361, 64009, 76176, 90000, 105625, 123201, 142884, 164836,
        189225, 216225, 246016, 278784, 314721, 354025, 396900, 443556, 494209, 549081, 608400,
    ];
